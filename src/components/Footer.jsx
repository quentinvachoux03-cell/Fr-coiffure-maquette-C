...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
        ...
        <div className="a-up">
          <div className="flex items-center gap-3">
            ...
            <div className="font-light tracking-widest uppercase" style={{ fontSize: 13, letterSpacing: '0.3em' }}>
              coiffure
            </div>
          </div>
          <p className="font-sans font-light mt-6 lg:mt-8 max-w-[280px]"
          ...
          <div className="flex items-center gap-3 mt-8 lg:mt-10">
            <div className="flex flex-col items-center justify-center rounded-full border"
            ...
            <div className="flex flex-col items-center justify-center text-center rounded-full border"
              style={{ width: 56, height: 56, borderColor: 'rgba(245,237,224,0.75)' }}>
        ...
        {/* Salon info */}
        <div className="a-up a-d2">
          <div className="mb-5 pb-3 border-b font-sans"
            style={{ fontSize: 11, letterSpacing: '0.3em', textTransform: 'uppercase', color: C_ORANGE, borderColor: 'rgba(245,237,224,0.2)' }}>
            {SALON.name}
          </div>
          ...
          <a href="#"
            ...
            style={{ fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', textDecoration: 'none', color: C_ORANGE, borderColor: C_ORANGE, paddingBottom: 4, transition: 'opacity 0.2s' }}
            onMouseEnter={(e) => e.currentTarget.style.opacity = '0.7'}
            onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}>
            Ouvrir l'itinéraire ↗
          </a>
        ...
        {/* Social + newsletter */}
        <div className="a-up a-d4">
          <div className="mb-5 pb-3 border-b font-sans"
            style={{ fontSize: 11, letterSpacing: '0.3em', textTransform: 'uppercase', color: C_ORANGE, borderColor: 'rgba(245,237,224,0.2)' }}>
            Suivez-nous
          </div>
          <div className="flex flex-col gap-3 mb-8">
            {[['Instagram', SALON.instagram], ['Facebook', SALON.facebook]].map(([platform, handle]) => (
              <a key={platform} href="#"
          ...
          <div className="mb-3 font-sans font-light"
            style={{ fontSize: 11, letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(245,237,224,0.6)' }}>
            Newsletter
          </div>
          <form className="flex border-b" style={{ borderColor: 'rgba(245,237,224,0.6)' }} onSubmit={(e) => e.preventDefault()}>
            <input type="email" placeholder="Votre adresse e-mail"
              className="flex-1 bg-transparent border-0 outline-none py-2 font-sans font-light"
              style={{ fontSize: 13, color: C_CREAM }} />
            <button className="bg-transparent border-0 cursor-pointer font-sans font-light"
              style={{ fontSize: 11, letterSpacing: '0.25em', textTransform: 'uppercase', color: C_ORANGE, transition: 'opacity 0.2s' }}
              onMouseEnter={(e) => e.currentTarget.style.opacity = '0.7'}
              onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}>
              S'inscrire →
            </button>
      ...
      <div className="a-fade a-d5 mt-14 lg:mt-20 pt-6 border-t flex flex-col sm:flex-row justify-between gap-2 font-sans font-light"
        style={{ borderColor: 'rgba(245,237,224,0.15)', fontSize: 11, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(245,237,224,0.55)' }}>
